...
- `3d/`: Enclosure and mechanical models.

Populate these folders with the latest design files as they are released. The v2.x hardware has been archived in [`../hardware-v2-legacy`](../hardware-v2-legacy/).
